...
namespace QPAS
{
    public static class GenericExtensions
    {
        ...
        public static void AddRange<T>(this IDbSet<T> collection, IEnumerable<T> items) where T : class
        {
            foreach (T item in items)
            {
                collection.Add(item);
        ...
        public static void RemoveRange<T>(this IDbSet<T> collection, IEnumerable<T> items) where T : class
        {
            foreach (T item in items)
            {
